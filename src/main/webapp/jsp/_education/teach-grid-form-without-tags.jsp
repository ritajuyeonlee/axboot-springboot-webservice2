            ...
            <ax:layout name="base">
                <jsp:attribute name="script">
                    ...
                    <script type="text/javascript"
                        src="<c:url value='/assets/js/view/_education/teach-grid-form-without-tags.js' />"></script>
                </jsp:attribute>
                <jsp:body>
                    ...
                    <div data-ax5layout="ax1" role="page-content"
                        data-config="{layout:'split-panel', orientation: 'vertical', splitter: {size: 7}}">
                                    ...
                                    <div data-ax-tbl class="ax-form-tbl">
                                            ...
                                            <div data-ax-td style="width:50%">
                                                ...
                                                <div data-ax-td-wrap>
                                                    <input type="text" name="companyNm" data-ax-path="companyNm"
                                                        title="회사명" class="form-control" data-ax-validate="required" />
                                                </div>
                                            </div>
                                            <div data-ax-td style="width:50%">
                                        ...
                                        <div data-ax-tr>
                                            <div data-ax-td style="width:50%">
                                                ...
                                                <div data-ax-td-wrap>
                                                    <input type="text" name="bizno" data-ax-path="bizno" title="사업자번호"
                                                        data-ax5formatter="bizno" class="form-control"
                                            ...
                                            <div data-ax-td style="width:50%">
                                                ...
                                                <div data-ax-td-wrap>
                                                    <input type="text" name="email" data-ax-path="email"
                                                        class="form-control" placeholder="x@x.xx" />
                                                </div>
                                            </div>
                                            <div data-ax-td style="width:50%">
                                        ...
                                        <div data-ax-tr>
                                            <div data-ax-td style="width:100%">
                                                ...
                                                <div data-ax-td-wrap>
                                                    <input type="text" name="addressDetail" data-ax-path="addressDetail"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                        </div>
