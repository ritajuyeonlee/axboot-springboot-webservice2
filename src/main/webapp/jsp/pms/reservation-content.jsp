    ...
    <%@ page contentType="text/html; charset=UTF-8" %>
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            <%@ taglib prefix="ax" tagdir="/WEB-INF/tags" %>
                <% RequestUtils requestUtils=RequestUtils.of(request); request.setAttribute("id",
                    requestUtils.getString("id")); %>
                                        ...
                                        <div data-ax-tbl class="ax-form-tbl">
                                            ...
                                            <div data-ax-tr>
                                                <div data-ax-td style="width:50%">
                                                    ...
                                                    <div data-ax-td-wrap>
                                                        <input type="text" name="id" data-ax-path="id"
                                            ...
                                            <div data-ax-tr>
                                                <div data-ax-td style="width:50%">
                                                    ...
                                                    <div data-ax-td-wrap>
                                                        <input type="text" name="companyNm" data-ax-path="companyNm"
                                                            title="회사명" class="form-control"
                                                ...
                                                <div data-ax-td style="width:50%">
                                                    ...
                                                    <div data-ax-td-wrap>
                                                        <input type="text" name="ceo" data-ax-path="ceo"
                                                            class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div data-ax-tr>
                                                <div data-ax-td style="width:50%">
                                                    ...
                                                    <div data-ax-td-wrap>
                                                        <input type="text" name="bizno" data-ax-path="bizno"
                                                            title="사업자번호" data-ax5formatter="bizno" class="form-control"
                                                ...
                                                <div data-ax-td style="width:50%">
                                                    ...
                                                    <div data-ax-td-wrap>
                                                        <input type="text" name="tel" data-ax-path="tel"
                                                            class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div data-ax-tr>
                                                <div data-ax-td style="width:50%">
                                                    ...
                                                    <div data-ax-td-wrap>
                                                        <input type="text" name="email" data-ax-path="email"
                                                            class="form-control inline-block" placeholder="x@x.xx" />
                                                    </div>
                                                </div>
                                                <div data-ax-td style="width:50%">
                                            ...
                                            <div data-ax-tr>
                                                <div data-ax-td style="width:100%">
                                                    ...
                                                    <div data-ax-td-wrap>
                                                        <input type="text" name="zip" data-ax-path="zip"
                                                            class="form-control inline-block W100"
                                                            readonly="readonly" />
                                                        <button class="btn btn-default"
                                                            data-form-view-01-btn="addressFind"><i
                                                                class="cqc-magnifier"></i> 찾기</button>
                                                        <div class="H5"></div>
                                                        <input type="text" name="address" data-ax-path="address"
                                                            class="form-control" readonly="readonly" />
                                                        <div class="H5"></div>
                                                        <input type="text" name="addressDetail"
                                                            data-ax-path="addressDetail" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div data-ax-tr>
                                                <div data-ax-td style="width:100%">
                                                    ...
                                                    <div data-ax-td-wrap>
                                                        <textarea name="remark" data-ax-path="remark" rows="5"
